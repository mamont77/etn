...
<!--
$Id: gss.xsl,v 1.4.2.1 2007/05/10 16:51:25 darrenoh Exp $
Derived from Google Sitmaps Stylesheets version 1.5a
(http://enarion.net/google/sitemaps/stylesheet/#download)
  ...
  <xsl:template match="/">
    <html>
      <head>
        ...
        <link href="https://www.google.com/webmasters/tools/docs/sitemaps.css" type="text/css" rel="stylesheet"/>
		<style type="text/css">
		  <![CDATA[
			<!--
			h1 {
			...
			.sortup {
				...
				background-image: url(https://www.google.com/webmasters/tools/images/sortup.gif);
			...
			.sortdown {
				background-position: right center;
				background-image: url(https://www.google.com/webmasters/tools/images/sortdown.gif);
				background-repeat: no-repeat;
				font-style:italic;
				white-space:pre;
      }
